...
Run with: python test_audio_manager.py
or: python -m realtimevoiceapi.smoke_tests.audio.test_audio_manager
"""
...
try:
    from realtimevoiceapi.audio.audio_manager import (
    ...
    from realtimevoiceapi.fast_lane.fast_vad_detector import VADState
