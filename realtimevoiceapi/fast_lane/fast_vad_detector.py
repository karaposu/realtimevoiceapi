# here is realtimevoiceapi/fast_lane/fast_vad_detector.py
...
class FastVADDetector:
    ...
    # In fast_vad_detector.py, update the process_chunk method to properly update metrics:
    ...
    def process_chunk(self, audio_chunk: AudioBytes) -> VADState:
        ...
        if energy > self.config.energy_threshold:
            ...
            if self.state == VADState.SILENCE:
                ...
                self.transitions += 1
                self.metrics.transitions += 1  # Update metrics too
                ...
                if self.state_duration_ms >= self.config.speech_start_ms:
                    ...
                    self.metrics.speech_segments += 1  # Update metrics too
                    self.transitions += 1  # This is also a transition
...
class AdaptiveVAD(FastVADDetector):
    ...
    # In fast_vad_detector.py, in AdaptiveVAD class:
