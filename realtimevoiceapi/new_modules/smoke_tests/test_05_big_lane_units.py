...
async def test_audio_processors():
    ...
    try:
        ...
        assert result2 is not None  # Should return accumulated speech
        print("  ✅ VADProcessor accumulates and filters speech")
